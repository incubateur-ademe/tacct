...
export const SecheressesPassees = (props: {
  ...
  const { moyenne: moyenneJoursAvecRestriction, annee: anneeMaxRestriction } =
    calculerMoyenneJoursMensuelleAvecRestriction({ secheresses });
  const exportData = IndicatorExportTransformations.gestionRisques
    .SecheressesPassees(secheresses)
        ...
        <div className={styles.dataTextWrapper}>
          <div className={styles.chiffreDynamiqueWrapper}>
            ...
            <Body weight="bold" style={{ color: 'var(--gris-dark)' }}>
              Sur la période 2020-2025, c'est en {anneeMaxRestriction} que votre
              territoire a connu le plus de restrictions liées à la sécheresse,
              avec une moyenne de {moyenneJoursAvecRestriction} jours de
              restriction par mois.
            </Body>
