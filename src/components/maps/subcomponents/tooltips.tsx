...
export const MoustiqueTigreTooltip = (nomDepartement: string, valeur: string, couleur: string) => {
  return `
    <div style="display: flex; flex-direction: column; padding: 0; width: max-content;">
      <p style="font-size: 1rem; font-family: Marianne; font-weight: 600; margin: 0">${nomDepartement}</p>
      <div style="display: flex; flex-direction: row; justify-content: space-between; padding: 0.25rem; gap: 0.5rem; align-items: center; width: max-content;">
        <div
          style="background-color: ${couleur}; width: 1rem; height: 1rem; border-radius: 2px; border: 0.5px solid #161616"
        ></div>
      <p style="font-size: 1rem; font-family: Marianne; font-weight: 400; margin: 0">${valeur}</p>
      </div>
    </div>
  `;
};
