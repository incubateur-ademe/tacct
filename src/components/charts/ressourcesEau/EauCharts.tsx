        ...
        {type !== 'departement' &&
          ...
          datavizTab === 'Répartition' && (
            <div className={styles.legendWrapper}>
              ...
              <Body style={{ fontSize: '10px', textTransform: 'uppercase' }}>
                {type} (%)
              </Body>
      ...
      {datavizTab === 'Répartition' ? (
        <>
          {type === 'pnr' || type === 'departement' ? (
            <PrelevementEauProgressBarsPNR
              ressourcesEau={
                ressourcesEau as unknown as PrelevementsEauParsed[]
              }
            />
          ) : (
            <PrelevementEauProgressBars
              ressourcesEau={
                ressourcesEau as unknown as PrelevementsEauParsed[]
              }
            />
